...
echo "<div style='font-size:1.5em; position: fixed; z-index:9999; top: 50%; left: 50%; transform: translate(-50%, -50%); background:white; padding:50px; border-radius:20px;' >
    ...
    <br> 
    Eğer hesabınız yok ise <a style='color:limegreen; padding:5px 10px;' href='https://betabahis.tech/signin' >Kayıt Ol</a>
    </div>";
 ...
 ?>
    ...
    <script type="text/javascript">
        ...
        function openHogaming(id) {
            ...
            window.location.href = "https://betabahis.tech/LiveCasino/Slot";
    ...
    $gameUrl = "https://betabahis.tech/GameLoby/Game/".$gameId[1];
