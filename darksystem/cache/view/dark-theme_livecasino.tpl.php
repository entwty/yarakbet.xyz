...
<div class="games-container">
    ...
    <?php 
     ...
     ?>
        ...
        <div class="casino-image">
            <img onclick="openHogaming(<?php if(isset($gamekey)) { echo $gamekey;}?>)" src="<?php echo $game['game_image']; ?>">
            <div class="game-data">
    ...
    <div class="games-forcenter">
        ...
        <div class="casino-image" onclick="openHogaming(<?php if(isset($gamekey)) { echo $gamekey;}?>)">
