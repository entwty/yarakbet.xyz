...
<section id="main" class="virtualgames sportsbook_padding newCasino">
    ...
    <div id="large-slider" class="carousel slide mobile-casino" data-ride="carousel">
        <ol class="carousel-indicators">
            <?php $i = 0;  ?>
            <?php foreach($gr_banners as $key => $banner){ ?>
                    ...
                    <div class="container">
                        <div id="main-center">
                            <div class="center-container ">
                                ...
                                <div class="row version-<?php echo permalink($key); ?>">
                                    <?php foreach ($gr_games as $gamekey => $game) {  ?>
                                    <div class="col-md-3 casino-image nw-action" onclick="openVirtualGame(<?php echo $game->code;?>)" >
                                        <img src="<?php echo $game->image; ?>">
                                        <div class="fullgamename"><?php echo $game->name; ?></div>
