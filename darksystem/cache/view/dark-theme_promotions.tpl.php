                        ...
                        <?php foreach($promosyonlar as $a => $promos){ ?>
                            <div class="col-sm-4 promotions-banner"   >
                                <a href="#<?php echo $promos->seourl; ?>" class="promo " >
                                    <img alt="" class="img-responsive" src="<?php echo $promos->resim; ?>">
                                </a>
                            </div>
                        <?php } ?> 
                        </div>
...
<?php foreach($promosyonlar as $a => $promos){ ?>
<div class="remodal" data-remodal-id="<?php echo $promos->seourl; ?>" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc"  >
