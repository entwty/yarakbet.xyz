                   ...
                   <!-- <div id="leftbar">
                        <div class="p_left_side">
                           <div class="popular_leagues">
                                <a onclick="$.ligBulten(104, 0)" class="league_item">
                                ...
                                <a onclick="$.ligBulten(405, 0)" class="league_item">
                                ...
                                <a onclick="$.ligBulten(91, 0)" class="league_item">
                                ...
                                <a onclick="$.ligBulten(180, 0)" class="league_item">
                                ...
                                <a onclick="$.ligBulten(2, 0)" class="league_item">
                                ...
                                <a onclick="$.ligBulten(120, 0)" class="league_item">
                                ...
                                <a onclick="$.ligBulten(201, 0)" class="league_item">
                                ...
                                <a onclick="$.ligBulten(383, 0)" class="league_item">
                                ...
                                <a onclick="$.ligBulten(95, 0)" class="league_item">
                                ...
                                <a onclick="$.ligBulten(1486030, 0)" class="league_item">
