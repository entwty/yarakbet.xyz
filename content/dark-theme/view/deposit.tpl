                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="bitcoinnamesurname" value="{$bilgi["name"]}" type="text" readonly="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="tethernamesurname" value="{$bilgi["name"]}" type="text" readonly="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="jetonnamesurname" value="{$bilgi["name"]}" type="text" readonly="">
                                                </div>
                                            </div>
