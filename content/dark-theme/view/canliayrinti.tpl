...
$url = "https://betsapi.tech/api/liveodds.php?token=betsapi.tech&matchid=" . $mac["botid"];

//$url = "https://betsapi.tech/api/presportsodds.php?token=betsapi.tech&matchid=" . $mac["botid"];
//echo $url;
