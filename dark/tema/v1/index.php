...
<html class="fixed sidebar-left-collapsed">
	<head>
        ...
        <script src="https://kit.fontawesome.com/9a35fe46df.js" crossorigin="anonymous"></script>
...
<!--        </script>-->
	...
	<body>
		...
		<audio id="notification">
            <source src="<?php echo SITE_URL; ?>/notification.ogg" type="audio/ogg">
            <source src="<?php echo SITE_URL; ?>/notification.mp3" type="audio/mpeg">
        </audio>
		<!-- #notification -->
