                ...
                <div class="col-12">
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($sqlFindManualMatchResult as $manualMatches) : ?>
                            <tr>
                                <th scope="row"><?=$manualMatches['match_id']?></th>
                                <td><?=$manualMatches['sport_id']?></td>
                                <td><?=$manualMatches['country_id']?></td>
                                <td><?=$manualMatches['league_id']?></td>
                                <th scope="row"><?=$manualMatches['match_result']?></th>
                                <td><?=$manualMatches['home_team']?></td>
                                <td><?=$manualMatches['away_team']?></td>
                                <td><?=$manualMatches['goal_detail']?></td>
                                <td><?=$manualMatches['match_datetime']?></td>
                                <td>
                                    <form action="<?php echo SITE_URL; ?>/updateMatch" method="post">
                                        <input class="btn btn-sm btn-primary" type="hidden" name="manual_match_id" value="<?=$manualMatches['id'];?>">
