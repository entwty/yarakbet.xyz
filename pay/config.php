<?php
  ...
  */
    define("HTTP", "https://");
    define("PATH", HTTP."pay.betabahis.tech");
  ...
  */
    ...
    define("DB_NAME", "betsapi");
    define("DB_USER", "betsapi");
    define("DB_PASS", "Rc123123+");

    define("DB_HOST2", "localhost");
    define("DB_NAME2", "betsapi");
    define("DB_USER2", "betsapi");
    define("DB_PASS2", 'Rc123123+');
