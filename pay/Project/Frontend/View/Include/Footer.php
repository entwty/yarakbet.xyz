              ...
              <footer class="page-footer">
                ...
                <div class="playgo-content">
                  <div class="container flex-container">
                    <div class="playgo-text flex-item">Betabahis Malta Gaming Lisans Numarası C84078 ve NUMBER1GAMING Financial Office 115A, LEVEL 5, VALLEY ROAD, GC Gaming kayıt adresi ile Çuracao şirketi tarafından yönetilmektedir. </div>
                  </div>
                </div>
                <div class="footer-copyright">
                  <div class="container center">
                    <span class="center">© betabahis.tech 2023. Tüm Hakları Saklıdır.</span>
                  </div>
                </div>
