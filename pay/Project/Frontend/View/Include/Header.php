          ...
          <app-bottom-menu class="hidden-lg hidden-md">
            <div class="bottom-fixed-controls">
              <div class="bottom-fixed-wrapper flex-container">
                <a class="flex-item truncate" routerlinkactive="active" href="https://bit.ly/3TAG3i0">
                ...
                <a class="button-collapse right-sidebar coupon" href="https://bit.ly/3TAG3i0"  id="bslpb">
                  <i aria-hidden="true" class="fa fa-plus"></i>
                  <span class="count-wrapper"></span>
                </a>
                <a class="flex-item truncate" href="livesports" routerlinkactive="https://bit.ly/3TAG3i0">
